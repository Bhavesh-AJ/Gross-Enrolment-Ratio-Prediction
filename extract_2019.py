...
def get_2019_data(file):
    ...
    # In the 2019 sheet, column 19 is the Grand Total faculty count.
    df_fac = df_fac.rename(columns={1: "state", 19: "faculty"})
    ...
    df_pop = pd.read_excel(file, sheet_name="38pop2019", skiprows=4, header=None)
